...
const Breadcrumb = (props) => {
  ...
  const defaultClass = bannerOnly
    ...
    : 'it-breadcrumb-area fix it-breadcrumb-bg evergreen-breadcrumb-banner p-relative';

  return (
    <div
      className={itemClass ? itemClass : defaultClass}
      style={{ backgroundImage: `url(${backgroundImage || breadcrumbBG})` }}
    >
      {!bannerOnly && (
        <>
