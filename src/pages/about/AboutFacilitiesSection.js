...
import { FACILITY_IMAGE_SETS } from '../../data/facilitiesImages';

const FacilityCarousel = ({ images, title, navIndex }) => {
...
const FACILITIES = [
  {
    ...
    images: FACILITY_IMAGE_SETS.schoolTransport,
  },
  {
    title: 'Library',
    ...
    images: FACILITY_IMAGE_SETS.library,
  },
  {
    title: 'Class Rooms',
    ...
    images: FACILITY_IMAGE_SETS.classRooms,
  },
  {
    ...
    images: FACILITY_IMAGE_SETS.chemistryLab,
  },
  {
    title: 'NCC',
    ...
    images: FACILITY_IMAGE_SETS.ncc,
  },
  {
    ...
    images: FACILITY_IMAGE_SETS.physicsLab,
  },
  {
    ...
    images: FACILITY_IMAGE_SETS.biologyLab,
  },
  {
    title: 'Computer Lab',
    ...
    images: FACILITY_IMAGE_SETS.computerLab,
  },
  {
    ...
    images: FACILITY_IMAGE_SETS.mathematicsLab,
  },
  {
    ...
    images: FACILITY_IMAGE_SETS.compositeScienceLab,
  },
  {
...
Robotics is a school programme for students to stimulate their tender minds to engage themselves with the latest technology around them. We train the young minds to nurture scientific outlook and to be future Techno scientists.`,
    images: FACILITY_IMAGE_SETS.stemRoboticsLab,
  },
  {
    ...
    images: FACILITY_IMAGE_SETS.interactiveClasses,
  },
];
          ...
          <div className="col-xl-10 col-lg-11">
            {FACILITIES.map((f, idx) => (
              ...
              >
                ...
                <FacilityCarousel images={f.images} title={f.title} navIndex={idx} />
                {f.body.split('\n\n').map((para, i) => (
